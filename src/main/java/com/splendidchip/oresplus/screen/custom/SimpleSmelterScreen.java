...
public class SimpleSmelterScreen extends AbstractContainerScreen<SimpleSmelterMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(OresPlus.MOD_ID, "textures/gui/simple_smelter/simple_smelter_gui.png");
    private static final ResourceLocation PROGRESS_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(OresPlus.MOD_ID, "textures/gui/simple_smelter/progress_arrow.png");
    private static final ResourceLocation FIRE_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(OresPlus.MOD_ID, "textures/gui/simple_smelter/lit_progress.png");

    public SimpleSmelterScreen(SimpleSmelterMenu menu, Inventory playerInventory, Component title) {
