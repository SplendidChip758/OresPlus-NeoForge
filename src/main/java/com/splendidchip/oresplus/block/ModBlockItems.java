...
public class ModBlockItems {
    ...
    public static final DeferredItem<BlockItem> SIMPLE_SMELTER_BLOCK_ITEM = ITEMS.registerSimpleBlockItem(
            ModBlocks.SIMPLE_SMELTER_BLOCK,
            new Item.Properties()
    );
    ...
    public static final DeferredItem<BlockItem> SMELTER_IO_BLOCK_ITEM = ITEMS.registerSimpleBlockItem(
            ModBlocks.SMELTER_IO_BLOCK,
            new Item.Properties()
    );

    public static final DeferredItem<BlockItem> ITEM_PIPE_BLOCK_ITEM = ITEMS.registerSimpleBlockItem(
            ModBlocks.ITEM_PIPE_BLOCK,
            new Item.Properties()
    );
